                      ...
                      >
                        ...
                        >
                          ...
                          <div className="mt-10 flex flex-wrap items-center gap-3 border-t border-white/10 pt-6">
                            <Link
                              to={`/projects/${project.slug}`}
                              className="public-action inline-flex h-11 items-center gap-3 border border-white/15 px-5 font-mono text-[10px] uppercase tracking-[0.2em] text-white hover:border-blue-500 hover:text-blue-400"
                            >
                              View Project
                            ...
                            {project.githubUrl && (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="public-action inline-flex h-11 items-center gap-3 border border-white/10 px-5 font-mono text-[10px] uppercase tracking-[0.2em] text-[#718091] hover:border-white/25 hover:text-white"
                              >
                                GitHub
                                <span className="text-sm">
                                  ↗
